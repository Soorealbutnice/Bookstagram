...
$(document).ready(function() {
	...
	$("#naverBtn").click(function() {
		$(location).attr("href", "${root}/login/naverlogin.dnb");
	});
	
	$("#googleBtn").click(function() {
		$(location).attr("href", "${root}/login/googleLogin.dnb");
	});
});
</script>
<style>
...
<div class="cover">
	<div class="loginbox">
		...
		<h1>Login</h1>
		<h3>인증이 완료되셨습니다.프로필을 설정해보세요</h3>
		<form name="loginform" method="post" action="">
			<input type="text" name="id" id="id" value="<%=id%>" placeholder="Enter Username">
