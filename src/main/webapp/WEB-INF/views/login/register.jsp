...
function idcheck() {
	...
	sendRequest("${root}/login", params, idresult, "GET");
}
...
<div class="cover">
	<div class="loginbox">
		...
		<form name ="joinform" method="post" action="">
			...
			<div>
				<h3>인증 받을 이메일을 입력하세요</h3>
				<br><br>
				<input type="email" class="email1" name="email1" id="email1" value="" placeholder="Email">@
