...
$(document).ready(function() {
   $("#modifyBtn").click(function() {
      if($("#title").val() == "") {
         ...
         $("#modifyForm").attr("method", "post").attr("action", modifypath).submit();                                           
      }
   });
...
<br>
<br>
<form id="modifyForm" name=""modifyForm"" method="post" action="" enctype="multipart/form-data">
<input type="hidden" name="post_no" id="post_no" value="${article.post_no}">
<input type="hidden" name="post_id" id="post_id" value="${article.post_id}">
<div id="attach_file_hdn"></div>
   <header class="header">
       <div class="container">
                <div class="mb-3">
                   <input type="text"  id="title" name="title" placeholder="제목을 입력하세요." value="${article.title}" style="height:100px;width:100%;font-size:40pt;border:0px;" maxlength="30">
                </div>
                <div>
                   <input type="text" id="simpleReview" name="simpleReview" placeholder="한줄평을 입력하세요." value="${article.simpleReview}" style="color:#999999;height:100px;width:80%;font-size:20pt;border:0px;" maxlength="200">
                </div>
                <div class="mb-3">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <div class="input-group mb-3">
                           <input id="bookName" type="search" class="form-control" placeholder="검색할 책을 입력하세요" value="${article.book_name}">
   ...
   <hr>
    <div class="container">
    <input type="hidden" name="bookImg" value="${article.bookImg}">
   <input type="hidden" name="book_name" value="${article.book_name}">
   <input type="hidden" name="bookInfo" value="${article.bookInfo}">
   <input type="hidden" name="isbn" value="${article.isbn}">
   <div id="selectedBook">
        <table>
          <tr>
             <td>
                  <img id="sBookImg"src="${article.bookImg}" style="width: 200; padding-top: 20px; padding-bottom: 20px">
            </td>
            <td style="padding: 20px; width:720px;">
                   <h4><span id="sBookTitle" name="sBookTitle">"${article.book_name}"</span></h4>
                   <p style="color: gray;" id="sBookInfo" name="sBookInfo">${article.bookInfo}</p> 
             </td>
          </tr>
       </table>
   </div>
      <main role="main">
            <textarea name="content" id="content" class="summernote" style="border:0px;">${article.content}</textarea> 
                <br>
              <div class="form-group row">
                <div class="col-3 mb-3">
                  <input class="form-control" id="hashtag1" name="hashtag1" type="text" placeholder="#" value="${article.hashtag1}">
                </div>
                <div class="col-3">
                  <input class="form-control" id="hashtag2" name="hashtag2" type="text" placeholder="#" value="${article.hashtag2}">
                </div>
                <div class="col-3">
                  <input class="form-control" id="hashtag3" name="hashtag3" type="text" placeholder="#" value="${article.hashtag3}">
                </div>
                <div class="col-3">
                  <input class="form-control" id="hashtag4" name="hashtag4" type="text" placeholder="#" value="${article.hashtag4}">
                </div>
              </div>
              <br>
          ...
          <hr>
         <div align="right">
                 <button type="submit" class="btn btn-outline-dark mr-2" id="modifyBtn">수정</button>
